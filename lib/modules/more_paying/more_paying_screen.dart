...
class MorePayingScreen extends StatelessWidget {
  MorePayingScreen({super.key, required this.used, required this.carModel});
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                if (carModel.carStatus == 'CarStatus.AVAILABLE')
                                  if (used == true)
                                    InkWell(
                                      onTap: () {
                                        navigateTo(
...
Future<void> makeChatWhatsApp(String number) async {
  final Uri whatsApp = Uri.parse('whatsapp://send?phone=$number}');
